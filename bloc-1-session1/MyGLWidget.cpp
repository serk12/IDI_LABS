...
void MyGLWidget::paintGL ()
{
  ...
  /*********************************************************/
  /*     EJERCICIO 2 CUADRADOS CON DOS TRIANGULOS      
  glDrawArrays(GL_TRIANGLE_STRIP, 0, 4);
  **********************************************************/
  /*********************************************************/
  /*     EJERCICIO 3 BUILD YOU A FUCKING HOUSE      
  glDrawArrays(GL_TRIANGLE_STRIP, 0, 5);
  **********************************************************/
...
/*********************************************************/
/*     EJERCICIO 1 CAMBIAR CORDENADAS DEL TRIANGULO      */
...
/*********************************************************/
/*     EJERCICIO 2 CUADRADOS CON DOS TRIANGULOS          
  glm::vec3 Vertices[4];  // Tres vèrtexs amb X, Y i Z triangle-strip
  Vertices[0] = glm::vec3(-1.0, -1.0, 0.0);
...
**********************************************************/    
/*********************************************************/
/*     EJERCICIO 3 BUILD YOU A FUCKING HOUSE MAN 
